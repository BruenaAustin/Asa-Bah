        ...
        <div class="container">
          ...
          <div class="row align-items-center mb-4" style="border: 1px solid gray">
            <div class="col-lg-6 py-3 text-center">
              ...
              <a href="jZ788YVJm9rgCFaJS.php" class="btn btn-primary mt-4">Leer más</a>
            </div>
          ...
          <div class="row align-items-center mb-4" style="border: 1px solid gray">
            <div class="col-lg-6 py-3 text-center">
              ...
              <a href="4e99f13402d5845f527cc56f7320b22f.php" class="btn btn-primary mt-4">Leer más</a>
            </div>
            <div class="col-lg-6 py-3">
              <div class="about-img" style="max-height: 400px; object-fit: cover">
          ...
          <div class="row align-items-center mb-4" style="border: 1px solid gray">
            <div class="col-lg-6 py-3 text-center">
              ...
              <a href="73c55ca55ace74e669655ee0ee36ef04.php" class="btn btn-primary mt-4">Leer más</a>
            </div>
            <div class="col-lg-6 py-3">
              <div class="about-img" style="max-height: 400px; object-fit: cover">
          ...
          <div class="row align-items-center mb-4" style="border: 1px solid gray">
            <div class="col-lg-6 py-3 text-center">
              ...
              <a href="798025b48145e9e5d634ea0bda3715f5.php" class="btn btn-primary mt-4">Leer más</a>
            </div>
            <div class="col-lg-6 py-3">
              <div class="about-img" style="max-height: 400px; object-fit: cover">
